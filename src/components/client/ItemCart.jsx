                    ...
                    <div className="cart__info">
                        ...
                        <div className="grid">
                            <div className="grid__item cart_select cart_item_name">
                               ...
                               <div className="cart__qty">
                                    <button
                                        ...
                                        onClick={() => handleDecrease(idproduct, item.object.variantId)}
                                    >
                                        -
                                    </button>
                                    <input
                                        ...
                                        min="1"
                                        max={50}
                                        onChange={(e) => handleChange(e,  item.object.variantId)}
                                    />
                                    <button
                                        type="button"
                                        className="qty-btn plus item-count"
                                        onClick={() => handleIncrease(idproduct, item.object.variantId)}
                                    >
                                        +
                                    </button>
                                </div>
                            ...
                            <div className="grid__item cart_select cart_item_price">
                                <p className="money">{formatPrice(item.object.price)}</p>
                            </div>
                        </div>
                    </div>
                </div>
