// 📄 src/components/discounts/EmbeddedPeriodForm.jsx
import React from "react";

export const EmbeddedPeriodForm = ({
  editingPeriod,
  periodFormData,
  ...
  handleClosePeriodEmbedded,
    ...
    return (
        ...
        <div className="card-header d-flex justify-content-between align-items-center">
          <h5 className="modal-title">{editingPeriod ? 'Sửa đợt giảm giá' : 'Thêm đợt giảm giá'}</h5>
          <div className="d-flex gap-2">
            <button type="button" className="btn btn-secondary" onClick={handleClosePeriodEmbedded}>Quay lại</button>
          </div>
        </div>
        <form onSubmit={handlePeriodSubmit}>
          <div className="card-body">
            ...
            <div className="row">
              <div className="col-md-12">
                <h6 className="mt-2">Quy tắc giảm theo Hóa đơn (tùy chọn)</h6>
              </div>
          ...
          <div className="card-footer d-flex justify-content-end gap-2">
            <button type="button" className="btn btn-secondary" onClick={handleClosePeriodEmbedded}>Hủy</button>
